...
> Both distributions of Kobe's and the simulated shooter are similarly right-skewed. We do not have evidence that Kobe has a hot hand given that in general he either made the shot or missed, while occasionally going on a shooting streak. 
...
ggplot(combine_streaks, aes(x = length, y = player, color = player)) +
  geom_boxplot() +
  geom_jitter(width = 0.2)

ggplot(combine_streaks, aes(x = length, y = player)) +
  geom_point()
